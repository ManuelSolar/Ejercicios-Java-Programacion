 ...
 *
 * donde los parámetros que se le pasan al constructor son el día, el mes y el a�o respectivamente. Si la fecha creada es incorrecta mostraremos un mensaje de error en la salida estándar de errores (lo ideal sería lanzar una excepción, ya lo haremos cuando se vea en clase).
 * 
 * Crea métodos para:
 * 
...
public class Fecha implements Comparable<Fecha>, Cloneable {
  ...
  public Fecha mas1Dia() {
    ...
    if (dia > diasMes(mes, anyo)) {
      ...
      dia = 1;
      mes++;
      if (mes>12) { // nos pasamos de diciembre, a�o siguiente
        mes = 1;
        anyo++;
      }
    }
  ...
  public Fecha menos1Dia() {
    ...
    if (dia==0) { // mes anterior y último día de mes
      ...
      dia = diasMes(mes, anyo); // �ltimo día del mes anterior
    }
    return new Fecha(dia, mes, anyo);
  }
